        ...
        <div className="fixed inset-x-0 bottom-0 z-50 flex h-[80vh] flex-col rounded-t-2xl border border-zinc-200 bg-white shadow-2xl sm:inset-x-auto sm:bottom-20 sm:right-5 sm:h-[560px] sm:w-[400px] sm:rounded-2xl dark:border-zinc-700 dark:bg-zinc-900">
          ...
          <div className="flex items-center justify-between border-b border-zinc-100 px-4 py-3 dark:border-zinc-800">
            ...
            <div className="flex items-center gap-2">
              ...
              {!liveOn && (
                <>
                  {/* The primary action in this panel, and now dressed like
                      it. It used to be grey text at the same weight as "New
                      chat", so the one thing worth doing here read as chrome
                      sitting next to it. */}
                  <button
                    type="button"
                    onClick={() => void startLive()}
                    title="Talk to Ria"
                    className="flex items-center gap-1.5 rounded-full bg-indigo-600 px-3 py-1.5 text-xs font-semibold text-white shadow-sm transition-colors hover:bg-indigo-700 focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:outline-none dark:bg-indigo-500 dark:hover:bg-indigo-400 dark:focus-visible:ring-offset-zinc-900"
                  >
                    <svg
                      width="13"
                      height="13"
