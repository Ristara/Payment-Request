      ...
      {links.map((l) => {
        ...
        return (
          <Link
            ...
            className={`sb-item mx-2 my-0.5 flex items-center gap-3 rounded-lg px-3 py-2 text-sm transition-colors ${
              active
          ...
          >
            ...
            <span className="sb-label flex-1 truncate">{l.label}</span>
            {typeof l.badge === "number" && l.badge > 0 && (
              <span
                className={`sb-badge rounded-full px-1.5 text-[10px] font-semibold ${
